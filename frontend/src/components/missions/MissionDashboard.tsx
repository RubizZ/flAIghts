...
import { CheckCircle2, Circle, X, Trophy, Map, LayoutGrid, ChevronLeft, ChevronRight, MessageSquareQuote } from 'lucide-react';
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
                        ...
                        <div id="dashboard-left-summary" className="w-full lg:w-2/5 flex flex-col items-center lg:items-start text-center lg:text-left">
                            ...
                            {!isRated && mission.isCompleted && (
                                ...
                                >
                                    <MessageSquareQuote size={16} className="sm:size-5 group-hover:rotate-12 transition-transform" />
