            ...
            <div className="absolute z-10 inset-0 h-full w-full overflow-y-auto overflow-x-hidden flex flex-col items-center px-4 p-[env(safe-area-inset-top)_env(safe-area-inset-right)_env(safe-area-inset-bottom)_env(safe-area-inset-left)]">
                <div className="w-full max-w-xl flex flex-col gap-4 text-center py-4 my-auto animate-fade-in-down">
                    ...
                    <div className="flex justify-start">
                        <button
                            onClick={handleExit}
                            className="relative overflow-hidden z-20 flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-br from-main to-surface border-3 border-line text-content hover:bg-surface transition-all group cursor-pointer shadow-lg opacity-95"
                        >
                            <PlaneBackground />
                            <div className="relative z-10 flex items-center gap-2">
                                ...
                                <span className="font-medium">{t("common.exit")}</span>
                            </div>
                        </button>
                    </div>
